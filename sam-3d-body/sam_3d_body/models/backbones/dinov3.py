...
class Dinov3Backbone(nn.Module):
    def __init__(
        ...
        source = "github"
        # Check for local dinov3 in checkpoints
        local_dinov3 = "/workspaces/sctsam3/checkpoints/dinov3"
        if os.path.exists(local_dinov3):
            print(f"Loading dinov3 from local path: {local_dinov3}")
            repo = local_dinov3
            source = "local"
